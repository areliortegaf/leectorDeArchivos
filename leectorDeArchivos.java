 ...
 * @author asortega
 */
public class leectorDeArchivos {
    
    
    //CONSTRUCTOR
    public leectorDeArchivos(){
        
    leerArchivo("propiedades.txt","inicio","fin");
    
    leerArchivo("HOLA.JS","//HOLA1","//HOLA2");
    
    leerArchivo("SELECT.sql","INICIO","FIN");
    }
    
    public static void main(String ... args){
        new leectorDeArchivos();
    }
    

    
    public String tipoArchivo(String pRutaArchivo){
    ...
    //
    public int lineasTotales(String archivoRuta) {
        int lineas = 0;
    ...
    private String leerArchivo(String RutaArchivo, String elInicio, String elFinal) {
